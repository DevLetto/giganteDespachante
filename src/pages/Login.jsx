...
function Login(){
    return(
      ...
      <form action="post" className='w-[400px] h-[616px] flex flex-col items-center  gap-15'>
        ...
        <fieldset className='w-full h-[330px] border-2 border-traco flex flex-col items-center pt-5 pl-1 pr-1 rounded-xl'>
          ...
          <input type="text" name='User' className='bg-white w-[95%] h-10 rounded-[10px] mb-[50px] p-1' />
          ...
          <input type="password" name="Password" className='bg-white w-[95%] h-10 rounded-[10px] p-1' />

        </fieldset>

        <button className='bg-white w-[210px] h-11 text-traco text-2xl rounded-[10px] hover:bg-traco hover:text-white '>
